      ...
      >
        <template v-slot="{ node, data }">
          <span class="custom-tree-node">
            <SvgIcon v-if="data.type == 'assignment'" name="assignment" class="assignment" />
            <SvgIcon v-if="data.type == 'decision'" name="decision" class="decision" />
            <SvgIcon v-if="data.type == 'startParallel'" name="startParallel" class="startParallel" />
            <SvgIcon v-if="data.type == 'endParallel'" name="endParallel" class="endParallel" />
            <SvgIcon v-if="data.type == 'machineLearning'" name="machineLearning" class="machineLearning" />
            <SvgIcon v-if="data.type == 'deepLearning'" name="deepLearning" class="deepLearning" />
