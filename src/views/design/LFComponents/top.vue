<template>
  <div>
    <div class="top">
      <div>
        <el-button size="small" type="primary" plain @click="viewJsonFunc"> 查看JSON </el-button>
        <el-button size="small" v-if="flowDetail.status != '2'" type="primary" :loading="saveLoading" @click="saveFunc"> 保存 </el-button>
      </div>
    </div>
    <!-- 查看JSON -->
